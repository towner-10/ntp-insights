	...
	return (
		<Dialog>
			<DialogContent>
				...
				<div className="text-sm">After counting the number of data entries in the <code>framepos</code> text file, NTP 360 determines the number of panoramas that it expects to be uploaded. Note that only numerically chronological file names, i.e., <code>0000000000, 0000000001, 0000000002, </code>etc. are accepted.</div>
